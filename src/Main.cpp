...
int main ( int argc, char* argv[] )
{
  ...
  //   halfadder->toXml( cout );
    ...
    // Net*      fa_cout_1 = new Net      ( fulladder, "carry_1", Term::Internal );
    // Net*      fa_cout_2 = new Net      ( fulladder, "carry_2", Term::Internal );

    // Instance* fa_1 =   new   Instance   ( fulladder, Cell::find("halfadder"), "halfadder_1" );
    // Instance* fa_2 =   new   Instance   ( fulladder, Cell::find("halfadder"), "halfadder_2" );
    ...
    // fa_1->connect("a"   ,fa_a);
    // fa_1->connect("b"   ,fa_b);
    // fa_1->connect("sout",fa_sout_1);
    // fa_1->connect("cout",fa_cout_1);

    // fa_2->connect("a"   ,fa_cin);
    // fa_2->connect("b",fa_sout_1);
    // fa_2->connect("sout", fa_sout);
    // fa_2->connect("cout",fa_cout_2);

    // fa_or2->connect("i0",fa_cout_1);
    // fa_or2->connect("i1",fa_cout_2);
